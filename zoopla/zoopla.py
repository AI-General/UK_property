...
url = "https://www.zoopla.co.uk/for-sale/property/london/?beds_max=1&beds_min=0&price_max=20000&price_min=20000&q=London&results_sort=newest_listings&search_source=for-sale"
page_number = 1
...
while True:
    ...
    for url in cleaned_urls:
        ...
        try:
            address = chrome.find_element('xpath', '(//address)[1]').text
        except:
            address = None
        ...
        try:
            description_elements = chrome.find_elements('xpath', '//p[@class="_15a8ens2"]/span')
            description_texts = [element.text for element in description_elements if element.text.strip()]
        except:
            description_texts = None
